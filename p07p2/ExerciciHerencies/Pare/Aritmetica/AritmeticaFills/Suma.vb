Public Class Suma
    ...
    Private Sub Suma_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Text = "Suma"
        lblOperacio.Text = "Suma"
        lblExplicacio.Text = "Per fer la suma desitjada, " & vbCrLf & "introdueix un numero a cada" & vbCrLf & "camp en blanc:"
        lbl1.Text = "Numero1"
        lbl2.Text = "Numero2"
        reinicarBoxes()
        MyBase.contador = 0
    ...
    Protected Overrides Sub calculaOperacio()
        ...
        Try
            ...
            MsgBox("La suma dels dos numeros es [" & resultat & "]")
